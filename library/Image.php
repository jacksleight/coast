...
class Image implements \Coast\App\Access, \Coast\App\Executable
{
    ...
    public function url($file, $actions = ['default'], array $params = [])
    {
        ...
        } elseif (! $file->isReadable() || ! in_array(strtolower($file->extName()), ['jpg', 'jpeg', 'png', 'gif'])) {
    ...
    public function process($file, $actions = ['default'], array $params = [])
    {
        if (\Coast\is_array_assoc($actions)) {
            $params = $actions;
            $actions = ['default'];
    ...
    public function run($name, InterventionImage $image, array $params = [])
    {
    ...
    public function __invoke($file, $actions = ['default'], array $params = [])
    {
